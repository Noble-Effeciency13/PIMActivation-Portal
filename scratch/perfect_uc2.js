...
const target1 = ".uc-mono     { font-family: ui-monospace, 'Cascadia Code', 'Fira Code', monospace; font-size: 11px; color: var(--text-muted); }";
const idx1 = css.indexOf(target1);
if (idx1 !== -1 && css.indexOf('.uc-expand-btn') === -1) {
  css = css.substring(0, idx1 + target1.length) + injectCss + css.substring(idx1 + target1.length);
